...
class UpdateComplaintForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Import STATUS_CHOICES_FOR_UPDATE from Student models
        from Student.models import STATUS_CHOICES_FOR_UPDATE
        # Set the status choices to exclude 'escalated'
        self.fields['status'].choices = STATUS_CHOICES_FOR_UPDATE
